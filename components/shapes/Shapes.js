...
export function Shapes({ isHover, isPress, mouseX, mouseY }) {
  ...
  return (
    <Canvas shadows dpr={[10, 10]} resize={{ scroll: false, offsetSize: true }}>
...
export function Lights() {
  return (
    <>
      <spotLight color="#1E73BE" position={[-10, -10, -10]} intensity={0.2} />
      <spotLight color="#1E73BE" position={[-10, 0, 15]} intensity={0.8} />
      <spotLight color="#1E73BE" position={[-5, 20, 2]} intensity={0.5} />
      <spotLight color="#1E73BE" position={[15, 10, -2]} intensity={2} />
      <spotLight color="#1E73BE" position={[15, 10, 5]} intensity={1} />
      <spotLight color="#1E73BE" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}
